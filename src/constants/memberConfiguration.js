...
export const memberConfiguration = {
  ...
  projects: [
    ...
    { key: "DAAI", name: "Daicolo-AIFeatures" , pointType: "STORYPOINT_HOURS_BASE" },
    { key: "ENT", name: "Enterprise Team" , pointType: "STORYPOINT_HOURS_BASE" },
    { key: "HG", name: "Hiruta GoDump" , pointType: "STORYPOINT_HOURS_BASE" },
    { key: "IP", name: "Internal PJ" , pointType: "STORYPOINT_HOURS_BASE" },
    { key: "IS", name: "Ishibashi Gakki" , pointType: "STORYPOINT_BASE" },
    { key: "KB", name: "Kuribara" , pointType: "STORYPOINT_HOURS_BASE" },
    { key: "MIT", name: "Mitaden" , pointType: "STORYPOINT_HOURS_BASE" },
    { key: "NKR2", name: "NikkenRentacom_2" , pointType: "STORYPOINT_HOURS_BASE" },
    { key: "OOPS", name: "Oops" , pointType: "STORYPOINT_HOURS_BASE" },
    { key: "PMAX", name: "PROMAX" , pointType: "STORYPOINT_HOURS_BASE" },
    { key: "PDS", name: "Product Design" , pointType: "STORYPOINT_HOURS_BASE" },
    { key: "RAG", name: "RAG" , pointType: "STORYPOINT_HOURS_BASE" },
    { key: "SG", name: "SCOP-GO" , pointType: "STORYPOINT_HOURS_BASE" },
    // { key: "STU", name: "SD - Time Utilization " , pointType: "STORYPOINT_HOURS_BASE" },
    { key: "SIP", name: "SD Internal Project" , pointType: "STORYPOINT_HOURS_BASE" },
    { key: "SEK", name: "Sekisuiheim" , pointType: "STORYPOINT_HOURS_BASE" },
    { key: "TG", name: "TOHO GAS" , pointType: "STORYPOINT_HOURS_BASE" },
    { key: "TOUC", name: "TOUCH" , pointType: "STORYPOINT_HOURS_BASE" },
    { key: "TIT", name: "Titans" , pointType: "STORYPOINT_HOURS_BASE" },
    { key: "TS", name: "Tokyu-Stay" , pointType: "STORYPOINT_HOURS_BASE" },
    ...
    { key: "ECHO", name: "echo", pointType: "STORYPOINT_HOURS_BASE"  }
  ],
  issueTypes: [
    "Bug",
    "Capacity",
